  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center p-6">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display text-xl font-bold text-encre">Erreur dans le back-office.</h1>
        ...
        <div className="mt-6 flex justify-center gap-3">
          ...
          <Button asChild variant="outline" size="sm">
            <Link href="/admin">Tableau de bord <ArrowRight className="ml-1.5 h-4 w-4" strokeWidth={1.5} /></Link>
          </Button>
        </div>
      </div>
    </div>
